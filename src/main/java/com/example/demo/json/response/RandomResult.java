package com.example.demo.json.response;
...
public final class RandomResult {
    ...
    public RandomResult(@JsonProperty("random") RandomData random,
    ...
    public String toString() {
        return "RandomResult [random=" + random + ", bitsUsed=" + bitsUsed + ", bitsLeft=" + bitsLeft + ", requestsLeft="
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RandomResult other = (RandomResult) obj;
