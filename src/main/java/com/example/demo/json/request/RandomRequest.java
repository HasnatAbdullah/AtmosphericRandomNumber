package com.example.demo.json.request;
...
public class RandomRequest {
    ...
    public RandomRequest(int id, String jsonrpc, String methodName, HttpParams httpParams) {
        this.id = id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        RandomRequest other = (RandomRequest) obj;
        if (httpParams == null) {
    ...
    public String toString() {
        return "RandomRequest [jsonrpc=" + jsonrpc + ", method=" + method + ", id=" + id + ", httpParams=" + httpParams
                + "]";
    }
